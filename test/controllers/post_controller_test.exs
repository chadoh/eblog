defmodule Eblog.PostControllerTest do
  use Eblog.ConnCase
  ...
  test "creates resource and redirects when valid", %{conn: conn, user: user} do
  ...
  test "does not create resource and renders errors when invalid", %{conn: conn, user: user} do
